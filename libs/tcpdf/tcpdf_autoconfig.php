...
if (!defined('K_PATH_IMAGES')) {
    $tcpdf_images_dirs = array(K_PATH_MAIN . 'examples/images/', K_PATH_MAIN . 'images/', '/usr/share/doc/php-tcpdf/examples/images/', '/usr/share/doc/tcpdf/examples/images/', '/usr/share/doc/php/tcpdf/examples/images/', '/var/www/tcpdf/images/', '/var/www/html/tcpdf/images/', '/usr/local/apache2/htdocs/tcpdf/images/', K_PATH_MAIN , 'public/img/');
...
if (!defined('PDF_CREATOR')) {
    define('PDF_CREATOR', 'DGB');
}

if (!defined('PDF_AUTHOR')) {
    define('PDF_AUTHOR', 'DGB');
}

if (!defined('PDF_HEADER_TITLE')) {
    define('PDF_HEADER_TITLE', 'DGB');
}
